...
/**
 * @author Seeker
 * @date 2019/1/11/011  13:15
 * @describe 提供为图片添加圆角、边框、剪裁到圆形或其他形状等功能。
 * from{@link # https://github.com/Tencent/QMUI_Android/blob/master/qmui/src/main/java/com/qmuiteam/qmui/widget/QMUIRadiusImageView.java}
 */
...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = array.getDimensionPixelSize(R.styleable.RoundImageView_riv_borderWidth, 0);
        mBorderColor = array.getColor(R.styleable.RoundImageView_riv_borderColor, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(R.styleable.RoundImageView_riv_selectedBorderWidth, mBorderWidth);
        mSelectedBorderColor = array.getColor(R.styleable.RoundImageView_riv_selectedBorderColor, mBorderColor);
        mSelectedMaskColor = array.getColor(R.styleable.RoundImageView_riv_selectedMaskColor, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(R.styleable.RoundImageView_riv_isTouchSelectModeEnabled, true);
        mIsCircle = array.getBoolean(R.styleable.RoundImageView_riv_isCircle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.RoundImageView_riv_isOval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(R.styleable.RoundImageView_riv_cornerRadius, 0);
        }
        array.recycle();
    }
