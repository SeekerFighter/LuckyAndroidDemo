...
import com.seeker.lucky.widget.recycleview.wrppper.GridLayoutManagerWrapper;
import com.seeker.lucky.widget.recycleview.wrppper.LinearLayoutManagerWrapper;
import com.seeker.lucky.widget.recycleview.wrppper.StaggeredGridLayoutManagerWrapper;
...
public class LuckyRecycleView extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (adapter instanceof LuckyRecyclerAdapter){
            ((LuckyRecyclerAdapter) adapter).setRecycleView(this);
        }
